...
;
    ...
    <section id="bo_v_online">
        <div class="form_online">
            <label for="wr_name">성함</label>
            <input type="text" name="wr_name" value="<?php echo $view['wr_name'] ?>" id="wr_name" required readonly class="frm_input half_input required">
        </div>
        <div class="form_online">
            <label for="wr_email">이메일</label>
            <input type="text" name="wr_email" value="<?php echo $view['wr_email'] ?>" id="wr_email" required readonly class="frm_input half_input email required">
        </div>
        <div class="form_online">
