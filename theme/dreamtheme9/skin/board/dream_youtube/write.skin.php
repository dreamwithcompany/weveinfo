...
<section id="bo_w">
    ...
    ?>
        ...
        <div class="write_div"> 
            <label for="wr_1" class="sound_only">유튜브 주소</label>
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input full_input" size="100" placeholder="유튜브 주소">
            <div style="color:#777;">
                ※ 예(일반)) https://www.youtube.com/watch?v=abcd <br>
                ※ 예(쇼츠)) https://www.youtube.com/shorts/abcd
            </div>
        </div>
