...
<link rel="stylesheet" href="<?php echo $board_skin_url?>/css/baguetteBox.min.css">
<script type="text/javascript" src="<?php echo $board_skin_url?>/js/baguetteBox.min.js"></script>
        ...
        <ul class="btn_bo_user">
            ...
            <li>
                ...
                <ul class="more_opt is_list_btn">
                    <li><button type="submit" name="btn_submit" value="선택수정" onclick="document.pressed=this.value">선택수정</button></li>
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div data-aos="fade-up" data-aos-easing="linear" class="gall_img thumbnail">
                    ...
                    <div data-aos="fade-up" data-aos-easing="linear" class="gall_text_href">
                        ...
                        <div class="bo_tit">
                         ...
                         <div class="bo_desc">
                            <p class="desc">
                                <em><?php echo $list[$i]['wr_1'] ?></em>
                                <span><?php echo $list[$i]['wr_2'] ?></span>
                            </p>
                            <p class="desc">
                                <em><?php echo $list[$i]['wr_3'] ?></em>
                                <span><?php echo $list[$i]['wr_4'] ?></span>
                            </p>
                            <p class="desc">
                                <em><?php echo $list[$i]['wr_5'] ?></em>
                                <span><?php echo $list[$i]['wr_6'] ?></span>
                            </p>
                            <p class="desc">
                                <em><?php echo $list[$i]['wr_7'] ?></em>
                                <span><?php echo $list[$i]['wr_8'] ?></span>
                            </p>
                            <p class="desc">
                                <em><?php echo $list[$i]['wr_9'] ?></em>
                                <span><?php echo $list[$i]['wr_10'] ?></span>
                            </p>
                         </div>
...
<script>
    ...
    function fboardlist_submit(f) {
        ...
        if (document.pressed == "선택수정") {
            ...
            $('.selec_chk:checked').each(function() {
                wr_id = $(this).val();
            });
            f.action = g5_bbs_url+ "/write.php?w=u&bo_table=<?php echo $bo_table ?>&wr_id=" + wr_id;
        }
