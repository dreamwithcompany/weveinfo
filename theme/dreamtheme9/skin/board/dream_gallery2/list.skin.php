...
<div id="bo_gall" style="width:<?php echo $width; ?>">
                ...
                <div class="gall_con">
                            ...
                            <?php } else {
                                ...
                                if($thumb['src']) {
                                    ...
                                    if ($board['bo_gallery_width'] > 0) {
                                        $img_content .= ' style="max-width:' . $board['bo_gallery_width'] . 'px; width: 100%;"';
                                    }
                                    $img_content .= ' class="img_content" >';
                                } else {
                    ...
                    <div class="gall_text_href" >
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit" style="text-overflow:ellipsis;white-space:nowrap;word-wrap:normal;overflow:hidden;">
                            ...
                            <?php } ?>
                            <span class="gall_tit"><?php echo $list[$i]['subject'] ?></span>
                            ...
                            ?>
                            <!-- <span class="gall_date"><span class="sound_only">등록일 </span>등록일 <?php echo $list[$i]['datetime'] ?></span> -->
                            <!-- <span class="gall_view"><span class="sound_only">조회수 </span>조회수 <?php echo $list[$i]['wr_hit'] ?></span> -->
                        </a>
                        <?php if ($is_category && $list[$i]['ca_name']) { ?>
                            <div class="bo_cate_box">
                                <span  class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></span>
                            </div>
                        <?php } ?>
                        <span class="bo_cnt"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 100, '..'); ?></span>
                        <a href="<?php echo $list[$i]['href'] ?>" class="more">MORE</a>
                    </div>
                    <!--<div class="gall_info">
    ...
    <script>
        ...
        // 자세히 보기
        /*$("#bo_gall .plus_btn").click(function(){
            $(this).closest('li').find('.bo_tb_box').slideToggle();
            $(this).closest('li').find('.fa-angle-down').toggleClass('active');
        });*/

        function setImageWidthHeight() {
            let img_content = document.querySelector('.img_content');
            if (img_content) {
                let width = img_content.offsetWidth;
                ...
                noImageSpans.forEach(function(noImageSpan) {
                    noImageSpan.style.width = width + 'px';
        ...
        window.addEventListener('load', setImageWidthHeight);
        window.addEventListener('resize', setImageWidthHeight);
    </script>
</div>
