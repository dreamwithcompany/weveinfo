...
<div id="bo_gall" style="width:<?php echo $width; ?>">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>">
                            <div class="fir_img">
                                ...
                                for ($j=0; $row=sql_fetch_array($result); $j++) {
                                    $img_array[$j] = $row['bf_file'];
                                }
                                if(isset($img_array[1])){ 
                                    $sec_img = thumbnail($img_array[1], G5_DATA_PATH.'/file/'.$bo_table, G5_DATA_PATH.'/file/'.$bo_table, $board['bo_gallery_width'], $board['bo_gallery_height'], false, true);
                                    if($sec_img){
                                    ?>
                                    <div class="sec_img">
                                        <img src="<?php echo G5_URL; ?>/data/file/<?php echo $bo_table.'/'.$sec_img?>">	
                                    </div>
                                    <?php } 
                                }
                                unset($img_array);
    ...
    <script>
        ...
        // 이미지 호버
        $(".fir_img img").mouseover(function () {
            $(this).closest('.fir_img').parent().find('.sec_img').fadeIn(500);
        });
        $(".fir_img").mouseleave(function () {
            $(".sec_img").fadeOut(500);
        }); 
