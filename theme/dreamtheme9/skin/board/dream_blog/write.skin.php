...
<section id="bo_w">
    ...
    <div class="write_div">      
        <label for="wr_1" class="sound_only">블로그주소</label>
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input full_input" size="100" placeholder="블로그주소">
    </div>
