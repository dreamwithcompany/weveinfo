        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    ?>
                    <div class="gall_img" style="float:<?php echo $pos ?>">
                    ...
                    <div class="gall_text_href" style="<?php echo $txt_pos ?>: 50px;">
                        ...
                        <span class="bo_cnt"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 150, '..'); ?></span>
