...
// 최신글 추출
// $cache_time 캐시 갱신시간
function latest_group($skin_dir='', $gr_id, $rows=10, $subject_len=40, $sel_bo_table='', $sel_bo_subject='', $cache_time=1, $options='')

{
    ...
    if(!G5_USE_CACHE || $cache_fwrite) {
        ...
        // 그룹별 전체 게시물을 가져와 게시판마다 10개씩만 추출하기 위해 limit 삭제
        $sql = " select a.*, b.bo_subject, c.gr_subject, c.gr_id {$sql_common} {$sql_order}";
